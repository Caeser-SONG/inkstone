...
import type { ChapterGuide, EditorPreferences, LibraryItem, ModelConfig, NovelProject, SavedChapter, StoryAnalysis, StoryEvidence, StoryMemoryStatus, WritingSkill } from "../types/story";
...
export function WritingView({ activeChapter, chapterTitle, draft, setDraft, wordCount, aiBusy, generateContinuation, setChatOpen, chatOpen, rightPanel, setRightPanel, storyAnalysis, agentBusy, onRunAgent, modelConfig, savedChapters, project, library, skills, editorPreferences, onEditorPreferencesChange, chapterGuide, onChapterGuideChange, onMemoryStatusChange, onMemoryEdit, onDismissCheck, onOpenEvidence }: { activeChapter: number; chapterTitle: string; draft: string; setDraft: (value: string) => void; wordCount: number; aiBusy: boolean; generateContinuation: () => void; setChatOpen: (value: boolean) => void; chatOpen: boolean; rightPanel: "insight" | "graph"; setRightPanel: (value: "insight" | "graph") => void; storyAnalysis: StoryAnalysis | null; agentBusy: boolean; onRunAgent: () => void; modelConfig: ModelConfig; savedChapters: SavedChapter[]; project?: NovelProject; library: LibraryItem[]; skills: WritingSkill[]; editorPreferences: EditorPreferences; onEditorPreferencesChange: (next: EditorPreferences) => void; chapterGuide: ChapterGuide; onChapterGuideChange: (guide: ChapterGuide) => void; onMemoryStatusChange: (memoryId: string, status: StoryMemoryStatus) => void; onMemoryEdit: (memoryId: string, title: string, detail: string) => void; onDismissCheck: (checkId: string) => void; onOpenEvidence: (evidence: StoryEvidence) => void }) {
