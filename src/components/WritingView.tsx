...
export function WritingView({ activeChapter, chapterTitle, draft, setDraft, wordCount, aiBusy, generateContinuation, setChatOpen, chatOpen, rightPanel, setRightPanel, storyAnalysis, agentBusy, onRunAgent, modelConfig, savedChapters }: { activeChapter: number; chapterTitle: string; draft: string; setDraft: (value: string) => void; wordCount: number; aiBusy: boolean; generateContinuation: () => void; setChatOpen: (value: boolean) => void; chatOpen: boolean; rightPanel: "insight" | "graph"; setRightPanel: (value: "insight" | "graph") => void; storyAnalysis: StoryAnalysis | null; agentBusy: boolean; onRunAgent: () => void; modelConfig: ModelConfig; savedChapters: SavedChapter[] }) {
